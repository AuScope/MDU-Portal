...
public class TestGSMLController {
    ...
    public void testYilgarnGeochemistryFilter() throws Exception{
        ...
        ModelAndView modelAndView = gsmlController.doYilgarnGeochemistryFilter("fake","fake","fake", "fake", null, mockHttpRequest);
    ...
    public void testYilgarnGeochemistryFilterInBbox() throws Exception{
        ...
        ModelAndView modelAndView = gsmlController.doYilgarnGeochemistryFilter("fake","fake","fake", "fake", bboxToParse, mockHttpRequest);
