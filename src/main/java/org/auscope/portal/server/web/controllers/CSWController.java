...
public class CSWController {
    ...
    public CSWController(CSWService cswService,
        ...
        //String cswServiceUrlList = portalPropertyPlaceholderConfigurer.resolvePlaceholder("HOST.cswservice.urlList");
        //logger.debug("cswServiceUrlList: " + cswServiceUrlList);
        
        //if (cswServiceUrlList != null)
        //	cswService.setServiceUrlList(cswServiceUrlList.split(";"));
