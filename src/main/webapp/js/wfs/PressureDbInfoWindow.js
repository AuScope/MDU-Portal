...
PressureDbInfoWindow.prototype = {
    ...
    'show': function() {
        ...
        summaryHtml += '<div align="right">' +
        						'<br/>' +
        			              '<input type="button" id="downloadDatasetBtn style = "visibility:visible;" value="Download Observations" name=butDownloadDataset onclick="openPressureDbDownloadWindow(\''+ this.boreholeId +'\',\''+ this.wfsServiceUrl +'\',\''+ this.geoServerUrl +'\')">';
        summaryHtml +=	'</div>';
        summaryHtml += '</body>';
        summaryHtml += '</html>';
